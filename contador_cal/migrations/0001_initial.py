# Generated by Django 5.1.3 on 2025-02-20 11:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medida', models.CharField(choices=[('Gramos', 'Gramos'), ('Mililitros', 'Mililitros')], default='GR', max_length=12)),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
            fields=[
                ...
                ('altura', models.FloatField(blank=True, max_length=5, null=True)),
                ...
                ('perfil_completado', models.BooleanField(blank=True, default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=200, unique=True)),
                ('usuario', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='comida', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Diario',
            fields=[
                ...
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dirio', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Pesos',
        ...
        migrations.CreateModel(
            name='Ingrediente',
            fields=[
                ('alimento_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='contador_cal.alimento')),
                ('cantidad', models.FloatField(max_length=10)),
                ('comida', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredientes', to='contador_cal.comida')),
            ],
            bases=('contador_cal.alimento',),
        ),
    ]
